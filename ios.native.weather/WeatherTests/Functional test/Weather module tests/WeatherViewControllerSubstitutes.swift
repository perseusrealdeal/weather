...
class MockGeoLocationReceiver : GeoLocationReceiverProtocol
{
...
fileprivate func verifyMethodCalledTwice(methodName        : String, callCount: Int,
                                         describeArguments : @autoclosure () -> String,
                                         file              : StaticString = #file,
                                         line              : UInt = #line) -> Bool
{
...
fileprivate func verifyMethodCalledThreeTimes(methodName        : String, callCount: Int,
                                              describeArguments : @autoclosure () -> String,
                                              file              : StaticString = #file,
                                              line              : UInt = #line) -> Bool
{
